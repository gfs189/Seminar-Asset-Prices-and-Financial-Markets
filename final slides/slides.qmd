...
::: {.highlight-box}
The FMB slope (0.14%) is slightly *positive* and the decile SML slopes down.
:::
...
- **Decile 1** $\alpha = +0.27\%$/month
- **Decile 6** : $\alpha \approx 0\%$
- **Decile 10** : $\alpha = -0.82\%$/month, $t = -3.16$

::: {.result-box}
Alpha spread (decile 1 → 10): approximately **−1.1 pp/month**
:::
:::
::: {}
...
Our TC estimate is an *extreme upper bound*. @frazziniisraelmoskowitz2015 find costs of in the **tens of basis points**.
...
- High-beta stocks more likely to be small, volatile and distressed
...
FMB insignificant and small FMB slope (0.14%/month (t=0.75)).
...
::: {.result-box}
BAB factor earns **8.85% annualised** (SR = 0.79, *t* = 6.08)
:::
:::
::: {}
**Transaction Costs**
...
Frazzini et al (2015), indicate 10 basis point TC
:::
